  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_9ctf_dtdef ((*x).ref_type);
      switch ((int) (0))
        {
        case 0:
          break;
      ...
      switch ((int) (ctf_dtu_d_union_selector (&((*x)))))
        ...
        case CTF_DTU_D_ARRAY:
          gt_ggc_m_9ctf_dtdef ((*x).dtd_u.dtu_arr.ctr_contents);
          gt_ggc_m_9ctf_dtdef ((*x).dtd_u.dtu_arr.ctr_index);
          break;
        ...
        case CTF_DTU_D_SLICE:
          gt_ggc_m_9ctf_dtdef ((*x).dtd_u.dtu_slice.cts_type);
          break;
        default:
          break;
        }
  ...
  while (x != xlimit)
    {
      ...
      gt_ggc_m_9ctf_dtdef ((*x).dmd_type);
...
gt_ggc_mx_ctf_func_arg (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_9ctf_dtdef ((*x).farg_type);
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_9ctf_dtdef ((*x).dvd_type);
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9ctf_dtdef))
    {
      ...
      gt_pch_n_9ctf_dtdef ((*x).ref_type);
      switch ((int) (0))
        {
        case 0:
          break;
      ...
      switch ((int) (ctf_dtu_d_union_selector (&((*x)))))
        ...
        case CTF_DTU_D_MEMBERS:
          ...
          break;
        case CTF_DTU_D_ARRAY:
          gt_pch_n_9ctf_dtdef ((*x).dtd_u.dtu_arr.ctr_contents);
          gt_pch_n_9ctf_dtdef ((*x).dtd_u.dtu_arr.ctr_index);
          break;
        case CTF_DTU_D_ENCODING:
          break;
        case CTF_DTU_D_ARGUMENTS:
          ...
          break;
        case CTF_DTU_D_SLICE:
          gt_pch_n_9ctf_dtdef ((*x).dtd_u.dtu_slice.cts_type);
          break;
        default:
          break;
        }
  ...
  while (x != xlimit)
    {
      ...
      gt_pch_n_9ctf_dtdef ((*x).dmd_type);
...
gt_pch_nx_ctf_func_arg (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_12ctf_func_arg))
    {
      gt_pch_n_9ctf_dtdef ((*x).farg_type);
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9ctf_dvdef))
    {
      ...
      gt_pch_n_9ctf_dtdef ((*x).dvd_type);
    }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (ctf_dtu_d_union_selector (&((*x)))))
    ...
    case CTF_DTU_D_ARRAY:
      if ((void *)(x) == this_obj)
        op (&((*x).dtd_u.dtu_arr.ctr_contents), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).dtd_u.dtu_arr.ctr_index), NULL, cookie);
      break;
    case CTF_DTU_D_ENCODING:
      break;
    case CTF_DTU_D_ARGUMENTS:
    ...
    case CTF_DTU_D_SLICE:
      if ((void *)(x) == this_obj)
        op (&((*x).dtd_u.dtu_slice.cts_type), NULL, cookie);
      break;
    default:
      break;
    }
