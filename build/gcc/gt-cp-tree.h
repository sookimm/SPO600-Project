  ...
  while (x != xlimit)
    {
      switch ((int) (cp_tree_node_structure (&((*x)))))
        ...
        case TS_CP_GENERIC:
          switch ((int) (tree_node_structure (&((*x).generic))))
            ...
            case TS_RAW_DATA_CST:
              gt_ggc_mx (&((*x).generic.raw_data_cst));
              break;
            case TS_COMPLEX:
        ...
        case TS_CP_TPI:
          ...
          break;
        case TS_CP_PTRMEM:
          gt_ggc_m_9tree_node ((*x).ptrmem.typed.type);
        ...
        case TS_CP_TRAIT_EXPR:
          gt_ggc_m_9tree_node ((*x).trait_expression.typed.type);
        ...
        case TS_CP_USERDEF_LITERAL:
          ...
          break;
        case TS_CP_TU_LOCAL_ENTITY:
          gt_ggc_m_9tree_node ((*x).tu_local_entity.name);
          break;
        default:
          break;
        }
...
void
gt_ggc_mx_hash_map_tree_location_t_decl_location_traits_ (void *x_p)
{
  hash_map<tree,location_t,decl_location_traits> * const x = (hash_map<tree,location_t,decl_location_traits> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct decl_location_traits& x_r ATTRIBUTE_UNUSED)
{
  struct decl_location_traits * ATTRIBUTE_UNUSED x = &x_r;
}
  ...
  while (x != xlimit)
    {
      switch ((int) (cp_tree_node_structure (&((*x)))))
        ...
        case TS_CP_GENERIC:
          switch ((int) (tree_node_structure (&((*x).generic))))
            ...
            case TS_STRING:
              ...
              break;
            case TS_RAW_DATA_CST:
              gt_pch_nx (&((*x).generic.raw_data_cst));
              break;
            case TS_COMPLEX:
        ...
        case TS_CP_TPI:
          ...
          break;
        case TS_CP_PTRMEM:
          gt_pch_n_9tree_node ((*x).ptrmem.typed.type);
        ...
        case TS_CP_ARGUMENT_PACK_SELECT:
          ...
          break;
        case TS_CP_TRAIT_EXPR:
          gt_pch_n_9tree_node ((*x).trait_expression.typed.type);
        ...
        case TS_CP_USERDEF_LITERAL:
          ...
          break;
        case TS_CP_TU_LOCAL_ENTITY:
          gt_pch_n_9tree_node ((*x).tu_local_entity.name);
          break;
        default:
          break;
        }
...
void
gt_pch_nx_hash_map_tree_location_t_decl_location_traits_ (void *x_p)
{
  hash_map<tree,location_t,decl_location_traits> * const x = (hash_map<tree,location_t,decl_location_traits> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_46hash_map_tree_location_t_decl_location_traits_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct decl_location_traits& x_r ATTRIBUTE_UNUSED)
{
  struct decl_location_traits * ATTRIBUTE_UNUSED x = &x_r;
}
  ...
  switch ((int) (cp_tree_node_structure (&((*x)))))
    ...
    case TS_CP_GENERIC:
      switch ((int) (tree_node_structure (&((*x).generic))))
        ...
        case TS_RAW_DATA_CST:
          if ((void *)(x) == this_obj)
            gt_pch_nx (&((*x).generic.raw_data_cst), op, cookie);
          break;
        case TS_COMPLEX:
          if ((void *)(x) == this_obj)
    ...
    case TS_CP_PTRMEM:
      if ((void *)(x) == this_obj)
        op (&((*x).ptrmem.typed.type), NULL, cookie);
      if ((void *)(x) == this_obj)
    ...
    case TS_CP_TRAIT_EXPR:
      if ((void *)(x) == this_obj)
        op (&((*x).trait_expression.typed.type), NULL, cookie);
      if ((void *)(x) == this_obj)
    ...
    case TS_CP_TU_LOCAL_ENTITY:
      if ((void *)(x) == this_obj)
        op (&((*x).tu_local_entity.name), NULL, cookie);
      break;
    default:
      break;
    }
...
void
gt_pch_p_46hash_map_tree_location_t_decl_location_traits_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_map<tree,location_t,decl_location_traits> * x ATTRIBUTE_UNUSED = (struct hash_map<tree,location_t,decl_location_traits> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct decl_location_traits* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_cp_tree_h[] = {
  ...
  },
  {
    &erroneous_templates,
    1,
    sizeof (erroneous_templates),
    &gt_ggc_mx_hash_map_tree_location_t_decl_location_traits_,
    &gt_pch_nx_hash_map_tree_location_t_decl_location_traits_
  },
  {
...
void
gt_clear_caches_gt_cp_tree_h ()
{
  gt_cleare_cache (erroneous_templates);
}
